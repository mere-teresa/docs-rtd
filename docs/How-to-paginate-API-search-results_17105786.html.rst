...
eZ Publish Platform 5.<next> : How to paginate API search results
=================================================================

Added by jerome.vieilledent@ez.no , edited by yannick.roger@ez.no on Oct
15, 2013
...
.. code:: theme:
    ...
    {% extends noLayout ? viewbaseLayout : "AcmeTestBundle::pagelayout.html.twig" %}
