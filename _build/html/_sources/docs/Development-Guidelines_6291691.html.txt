...
eZ Publish Platform 5.<next> : Development Guidelines
=====================================================
...
following example shows how this is done in the case of loading users:
...
<TODO: Expand on how best practice is to handle user input in eZ Publish
5 to avoid XSS issues>
...
-  It is recommended to avoid as much as possible statements which alter
   ...
   is abruptly terminated, the table might stay locked for a long time
